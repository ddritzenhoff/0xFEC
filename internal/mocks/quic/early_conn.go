...
//
//	mockgen -typed -build_flags=-tags=gomock -package mockquic -destination internal/mocks/quic/early_conn.go github.com/quic-go/quic-go EarlyConnection
//
...
func (m *MockEarlyConnection) OpenStreamSyncWithFEC(arg0 context.Context) (quic.Stream, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEarlyConnectionMockRecorder) OpenStreamSyncWithFEC(arg0 any) *MockEarlyConnectionOpenStreamSyncWithFECCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OpenStreamSyncWithFEC", reflect.TypeOf((*MockEarlyConnection)(nil).OpenStreamSyncWithFEC), arg0)
	return &MockEarlyConnectionOpenStreamSyncWithFECCall{Call: call}
}

// MockEarlyConnectionOpenStreamSyncWithFECCall wrap *gomock.Call
type MockEarlyConnectionOpenStreamSyncWithFECCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockEarlyConnectionOpenStreamSyncWithFECCall) Return(arg0 quic.Stream, arg1 error) *MockEarlyConnectionOpenStreamSyncWithFECCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockEarlyConnectionOpenStreamSyncWithFECCall) Do(f func(context.Context) (quic.Stream, error)) *MockEarlyConnectionOpenStreamSyncWithFECCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEarlyConnectionOpenStreamSyncWithFECCall) DoAndReturn(f func(context.Context) (quic.Stream, error)) *MockEarlyConnectionOpenStreamSyncWithFECCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockEarlyConnection) OpenUniStreamSyncWithFEC(arg0 context.Context) (quic.SendStream, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEarlyConnectionMockRecorder) OpenUniStreamSyncWithFEC(arg0 any) *MockEarlyConnectionOpenUniStreamSyncWithFECCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OpenUniStreamSyncWithFEC", reflect.TypeOf((*MockEarlyConnection)(nil).OpenUniStreamSyncWithFEC), arg0)
	return &MockEarlyConnectionOpenUniStreamSyncWithFECCall{Call: call}
}

// MockEarlyConnectionOpenUniStreamSyncWithFECCall wrap *gomock.Call
type MockEarlyConnectionOpenUniStreamSyncWithFECCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockEarlyConnectionOpenUniStreamSyncWithFECCall) Return(arg0 quic.SendStream, arg1 error) *MockEarlyConnectionOpenUniStreamSyncWithFECCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockEarlyConnectionOpenUniStreamSyncWithFECCall) Do(f func(context.Context) (quic.SendStream, error)) *MockEarlyConnectionOpenUniStreamSyncWithFECCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEarlyConnectionOpenUniStreamSyncWithFECCall) DoAndReturn(f func(context.Context) (quic.SendStream, error)) *MockEarlyConnectionOpenUniStreamSyncWithFECCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockEarlyConnection) SendDatagramWithFEC(arg0 []byte) error {
	m.ctrl.T.Helper()
...
func (mr *MockEarlyConnectionMockRecorder) SendDatagramWithFEC(arg0 any) *MockEarlyConnectionSendDatagramWithFECCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendDatagramWithFEC", reflect.TypeOf((*MockEarlyConnection)(nil).SendDatagramWithFEC), arg0)
	return &MockEarlyConnectionSendDatagramWithFECCall{Call: call}
}

// MockEarlyConnectionSendDatagramWithFECCall wrap *gomock.Call
type MockEarlyConnectionSendDatagramWithFECCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockEarlyConnectionSendDatagramWithFECCall) Return(arg0 error) *MockEarlyConnectionSendDatagramWithFECCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockEarlyConnectionSendDatagramWithFECCall) Do(f func([]byte) error) *MockEarlyConnectionSendDatagramWithFECCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEarlyConnectionSendDatagramWithFECCall) DoAndReturn(f func([]byte) error) *MockEarlyConnectionSendDatagramWithFECCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
